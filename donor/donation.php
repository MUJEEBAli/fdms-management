...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "INSERT INTO  donations(fullname,mobileno,adress,foodtype,foodquantity) VALUES(:fullname,:mobileno,:address,:foodtype,:fquantity)";
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<form method="post" class="form-horizontal" enctype="multipart/form-data">
												...
												<div class="form-group">
													<label class="col-sm-2 control-label">Food type <span style="color:red">*</span></label>
													<div class="col-sm-4">
													...
													<div class="col-sm-4">
														...
														<select name="fquantity" class="form-control" required>
															<option value="">Select</option>
												...
												<div class="form-group">
													<div class="col-sm-8 col-sm-offset-2">
														...
														<button class="btn btn-primary" name="submit" type="submit">Donate</button>
													</div>
												</div>
