...
if (isset($_POST['Register'])) {
    ...
    $email = $_POST['email'];
    $password = md5($_POST['donorpassword']);
    $sql = "INSERT INTO foodreceiver(FullName,PhoneNo,Adress,Username,Email,Password) VALUES(:fullname,:phoneno,:address,:username,:email,:donorpassword)";
                        ...
                        <div class="well row pt-2x pb-3x bk-light">
                            <div class="col-md-8 col-md-offset-2">
                                <form method="post">
                                    ...
                                    <input type="text" placeholder="phoneno" name="phoneno" class="form-control mb">
